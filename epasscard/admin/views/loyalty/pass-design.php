				...
				<tbody>
					...
					<tr class="epc-loyalty-builder-row" data-epc-design-panel="builder">
						...
						<td>
							...
							<p class="description"><?php esc_html_e( 'Design the full pass in EpassCard (logo, strip, colors, extra fields), then refresh this list and select the template. Placeholders such as {Points}, {Name}, {Member No}, and {Tier} are mapped automatically.', 'epasscard' ); ?></p>
						</td>
					</tr>
