...
$epc_loyalty_render_milestone = static function ( array $milestone, $lock_id, $open = false ) use ( $reward_types, $epc_loyalty_reward_amount_label ) {
	...
	?>
	<div class="epc-loyalty-item epc-loyalty-item--accordion<?php echo $open ? ' is-open' : ''; ?>" data-epc-repeater-item>
		<div class="epc-loyalty-item__head">
			<button type="button" class="epc-loyalty-item__toggle" aria-expanded="<?php echo $open ? 'true' : 'false'; ?>">
				...
				<span class="epc-loyalty-item__preview">
					<?php
					echo esc_html(
						sprintf(
 ...
 * @return void
 */
$epc_loyalty_render_tier = static function ( array $tier, $lock_id ) {
	...
	<div class="epc-loyalty-item" data-epc-repeater-item>
		...
		<div class="epc-loyalty-fields">
			...
			<label class="epc-loyalty-field">
				...
				<input type="number" min="0" data-field="threshold" class="epc-loyalty-points-needed" value="<?php echo esc_attr( (string) (int) ( $tier['threshold'] ?? 0 ) ); ?>" />
			</label>
		</div>
	</div>
	<?php
